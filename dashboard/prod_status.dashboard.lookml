...
- dashboard: prod_status
  ...
  - title: Iteration Aggregation and Model Update Time
    ...
    type: looker_line
    fields: [iteration_aggregating_to_complete.iteration_id, iteration_aggregating_to_complete.duration_in_minutes]
    sorts: [iteration_aggregating_to_complete.duration_in_minutes desc 0]
    total: true
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_null_points: true
    interpolation: linear
    y_axes: [{label: '', orientation: left, series: [{axisId: iteration_aggregating_to_complete.duration_in_minutes,
            id: iteration_aggregating_to_complete.duration_in_minutes, name: Duration In Minutes}],
        showLabels: true, showValues: true, unpinAxis: false, tickDensity: default,
        tickDensityCustom: 5, type: log}]
    x_axis_zoom: true
    y_axis_zoom: true
